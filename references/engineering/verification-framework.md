<!-- Part of the Auto Engineer skill. Load this file when the agent needs guidance on TDD verification per sub-task, verification signals, integration testing, and failure handling. -->

# Verification Framework

Every Auto Engineer sub-task must prove it works before closing. This reference covers the TDD workflow, verification signals, integration testing, and the verification report format.
